...
export const ProductUpload = ({ onChange, message, formData, errors, fileName, productPrice, fileHandler, submitHandler }) => {
...
console.log(formData)
        ...
        <Box component="form" noValidate mt={2} onSubmit={(e) => submitHandler(e)}>
            <Grid container spacing={2}>
                ...
                /> */}
                    <Autocomplete
                        {...flatProps}
                        inputValue = {formData.productType ? formData.productType:''}
                        ...
                        disableClearable
                        renderInput={(params) => (
                            <TextField {...params} label="ProductType" variant="standard" />
                        )}
                    />
                </Grid>
                <Grid item xs={12} sm={6}>
                ...
                <Grid item xs={12}>
                    ...
                    <Grid>
                        {fileName ? fileName : formData.productImage}
                    </Grid>
                </Grid>
            </Grid>
            <Button
    ...
    return (
        location.pathname === '/Product%20Upload' ?
